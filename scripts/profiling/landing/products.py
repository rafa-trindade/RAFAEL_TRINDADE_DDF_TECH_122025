...
PARQUET_GLOB = (
    ...
    "run_id=*/olist_products_dataset.parquet"
)
...
md_file = init_md_report(
    report_filename="products.md",
    dataset_name="landing/products",
    layer="landing",
)
...
# VOLUMETRIA ####################################
##################################################
md = "### 📦 Volumetria: `landing/products`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Campos de Data: `landing/products`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `landing/products`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `landing/products`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `landing/products`\n"
