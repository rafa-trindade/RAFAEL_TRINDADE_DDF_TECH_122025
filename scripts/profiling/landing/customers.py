...
PARQUET_GLOB = (
    ...
    "run_id=*/olist_customers_dataset.parquet"
)
...
md_file = init_md_report(
    report_filename="customers.md",
    dataset_name="landing/customers",
    layer="landing",
)
...
# VOLUMETRIA ####################################
##################################################
md = "### 📦 Volumetria: `landing/customers`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Campos de Data: `landing/customers`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `landing/customers`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `landing/customers`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `landing/customers`\n"
