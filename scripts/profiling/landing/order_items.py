...
PARQUET_GLOB = (
    ...
    "run_id=*/olist_order_items_dataset.parquet"
)
...
md_file = init_md_report(
    report_filename="order_items.md",
    dataset_name="landing/order_items",
    layer="landing",
)
...
# VOLUMETRIA ####################################
##################################################
md = "### 📦 Volumetria: `landing/order_items`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Campos de Data: `landing/order_items`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `landing/order_items`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `landing/order_items`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `landing/order_items`\n"
