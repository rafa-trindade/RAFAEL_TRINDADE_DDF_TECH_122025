...
PARQUET_GLOB = (
    ...
    "run_id=*/olist_orders_dataset.parquet"
)
...
md_file = init_md_report(
    report_filename="orders.md",
    dataset_name="landing/orders",
    layer="landing",
)
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Campos de Data: `landing/orders`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `landing/orders`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `landing/orders`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `landing/orders`\n"
